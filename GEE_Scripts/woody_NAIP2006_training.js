var table = ee.FeatureCollection("projects/uiriparian/assets/Salmon_FO_extent"),
    water = /* color: #1315d6 */ee.FeatureCollection(
        ...
        ee.Feature(
            ee.Geometry.Point([-113.66225396044665, 44.8383169475956]),
            {
              "class": 2,
              "system:index": "167"
            }),
        ...
        ee.Feature(
            ee.Geometry.Point([-113.47314287815273, 44.745276401826814]),
            {
              "class": 2,
              "system:index": "205"
            }),
        ee.Feature(
            ee.Geometry.Point([-113.47073997455976, 44.743431772237756]),
            {
              "class": 2,
              "system:index": "206"
            }),
        ee.Feature(
            ee.Geometry.Point([-113.47869114395924, 44.751084000331055]),
            {
              "class": 2,
              "system:index": "207"
            }),
        ee.Feature(
            ee.Geometry.Point([-113.48198364635772, 44.754203594301316]),
            {
              "class": 2,
              "system:index": "208"
            }),
        ee.Feature(
            ee.Geometry.Point([-113.48465321047802, 44.75545621081025]),
            {
              "class": 2,
              "system:index": "209"
            }),
        ee.Feature(
            ee.Geometry.Point([-113.49415782640726, 44.76063157925564]),
            {
              "class": 2,
              "system:index": "210"
            }),
        ee.Feature(
            ee.Geometry.Point([-113.55308203714473, 44.78739836077291]),
            {
              "class": 2,
              "system:index": "211"
            }),
        ee.Feature(
            ee.Geometry.Point([-113.55179615652308, 44.79657573590481]),
            {
              "class": 2,
              "system:index": "212"
            }),
        ee.Feature(
            ee.Geometry.Point([-113.78390885876182, 45.12033754599471]),
            {
              "class": 2,
              "system:index": "213"
            }),
        ee.Feature(
            ee.Geometry.Point([-113.79562884101155, 45.128444397364575]),
            {
              "class": 2,
              "system:index": "214"
            })]),
    ...
    herb = /* color: #30e04a */ee.FeatureCollection(
        ...
        ee.Feature(
            ee.Geometry.Point([-113.91037891008787, 45.320734797473484]),
            {
              "class": 1,
              "system:index": "2"
            }),
        ...
        ee.Feature(
            ee.Geometry.Point([-113.7930192084446, 45.28958400954147]),
            {
              "class": 1,
              "system:index": "5"
            }),
        ...
        ee.Feature(
            ee.Geometry.Point([-113.9186043800036, 45.056958156599165]),
            {
              "class": 1,
              "system:index": "30"
            }),
        ...
        ee.Feature(
            ee.Geometry.Point([-113.99904672328219, 44.899420189886115]),
            {
              "class": 1,
              "system:index": "37"
            }),
        ...
        ee.Feature(
            ee.Geometry.Point([-113.43706681864728, 44.59761891081587]),
            {
              "class": 1,
              "system:index": "148"
            }),
        ee.Feature(
            ee.Geometry.Point([-113.43662157195081, 44.59764564914292]),
            {
              "class": 1,
              "system:index": "149"
            }),
        ...
        ee.Feature(
            ee.Geometry.Point([-113.427828795754, 44.75140080216946]),
            {
              "class": 1,
              "system:index": "187"
            }),
        ...
        ee.Feature(
            ee.Geometry.Point([-113.98821353617697, 45.01508257662629]),
            {
              "class": 1,
              "system:index": "213"
            }),
        ee.Feature(
            ee.Geometry.Point([-113.98936152163535, 45.01569691259936]),
            {
              "class": 1,
              "system:index": "214"
            })]),
...
var img = ee.ImageCollection('USDA/NAIP/DOQQ')
                  ...
                  .map(addExG);
var badTiles = [
  'n_4411305_nw_12_2_20060716',
  'n_4411305_sw_12_2_20060716',
  'n_4411314_ne_12_2_20060717',
  'n_4411315_nw_12_2_20060717',
  'n_4411315_se_12_2_20060717',
  'n_4411332_ne_12_2_20060717',
  'n_4411233_nw_12_2_20060717']
var img2023 = img
  .filterDate('2006-01-01','2006-12-31')
  .filterDate('2006-07-01','2006-10-01')
  .filter(ee.Filter.inList('system:index',badTiles).not())
  .mosaic();
Map.addLayer(img2023)

///////////////////////////////////////////////////////////////////////
// we also created a texture layer based on green for 2004/2006, nir for the rest of years
...
var predictionBands = ['B','G','R','entropy','contrast','gearys',
'VARI','TGI','ExG']
