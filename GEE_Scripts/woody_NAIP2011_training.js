var table = ee.FeatureCollection("projects/uiriparian/assets/Salmon_FO_extent"),
    water = /* color: #1315d6 */ee.FeatureCollection(
        ...
        ee.Feature(
            ee.Geometry.Point([-113.47049393233232, 44.57952283594042]),
            {
              "class": 2,
              "system:index": "205"
            }),
        ee.Feature(
            ee.Geometry.Point([-113.4698072868245, 44.57885034462435]),
            {
              "class": 2,
              "system:index": "206"
            }),
        ee.Feature(
            ee.Geometry.Point([-113.49451502016875, 44.707006654893036]),
            {
              "class": 2,
              "system:index": "207"
            }),
        ee.Feature(
            ee.Geometry.Point([-113.6088941935605, 44.76842984660868]),
            {
              "class": 2,
              "system:index": "208"
            }),
        ee.Feature(
            ee.Geometry.Point([-113.60893710890474, 44.76803375956164]),
            {
              "class": 2,
              "system:index": "209"
            }),
        ee.Feature(
            ee.Geometry.Point([-113.86949593535074, 44.80274080115413]),
            {
              "class": 2,
              "system:index": "210"
            }),
        ee.Feature(
            ee.Geometry.Point([-113.87052590361246, 44.80176639209844]),
            {
              "class": 2,
              "system:index": "211"
            }),
        ee.Feature(
            ee.Geometry.Point([-113.85747963896402, 44.81077904790899]),
            {
              "class": 2,
              "system:index": "212"
            }),
        ee.Feature(
            ee.Geometry.Point([-113.96472703401, 44.88946743999097]),
            {
              "class": 2,
              "system:index": "213"
            }),
        ee.Feature(
            ee.Geometry.Point([-113.96908294145018, 44.88717187586786]),
            {
              "class": 2,
              "system:index": "214"
            })]),
    ...
    herb = /* color: #30e04a */ee.FeatureCollection(
        ...
        ee.Feature(
            ee.Geometry.Point([-113.98596290770755, 44.89420653282881]),
            {
              "class": 1,
              "system:index": "30"
            }),
        ee.Feature(
            ee.Geometry.Point([-113.98866120997653, 44.89495136992151]),
            {
              "class": 1,
              "system:index": "31"
            }),
        ...
        ee.Feature(
            ee.Geometry.Point([-113.05338793324235, 44.36758819532312]),
            {
              "class": 1,
              "system:index": "47"
            }),
        ee.Feature(
            ee.Geometry.Point([-113.05301242398026, 44.375391600744045]),
            {
              "class": 1,
              "system:index": "48"
            }),
        ...
        ee.Feature(
            ee.Geometry.Point([-113.03259601220739, 44.40019342803926]),
            {
              "class": 1,
              "system:index": "210"
            }),
        ...
        ee.Feature(
            ee.Geometry.Point([-113.87786657037185, 45.068462564895356]),
            {
              "class": 1,
              "system:index": "213"
            }),
        ee.Feature(
            ee.Geometry.Point([-113.99538742556147, 44.92572963118963]),
            {
              "class": 1,
              "system:index": "214"
            })]),
...
// functions to add vegetation indices
...
var badTiles =[
  'm_4411315_se_12_1_20110816',
  'm_4411332_nw_12_1_20110816',
  'm_4411332_ne_12_1_20110816',
  'm_4411332_se_12_1_20110816',
  'm_4411340_ne_12_1_20110816',
  'm_4411233_nw_12_1_20110816',
  'm_4411233_sw_12_1_20110816']
  
var img2023 = img
  .filterDate('2011-01-01','2011-12-31')
  .filterDate('2011-08-12','2011-08-17')
...
var predictionBands = ['B','G','R','N','NDVI','entropy','contrast','gearys','GRVI','VARI','TGI']
